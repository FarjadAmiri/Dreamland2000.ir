...
namespace WebSite.Migrations
{
    ...
    [Migration("20250416142337_16april2025-ch01")]
    partial class _16april2025ch01
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebSite.DataLayer.Entities.RealEstate.RealEstate", b =>
                {
                    ...
                    b.Property<string>("UnitCharge")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<int?>("UsageRefId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebSite.DataLayer.Entities.RealEstate.RealEstateBuildingDirection", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
                    ...
                    b.ToTable("RealEstateBuildingDirection");
                });
            ...
            modelBuilder.Entity("WebSite.DataLayer.Entities.RealEstate.RealEstateProject", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("RealEstateProject");
                });

            modelBuilder.Entity("WebSite.DataLayer.Entities.RealEstate.RealEstateProjectComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("RealEstateProjectComment");
                });

            modelBuilder.Entity("WebSite.DataLayer.Entities.RealEstate.RealEstateProjectPhoto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("RealEstateProjectPhoto");
                });

            modelBuilder.Entity("WebSite.DataLayer.Entities.RealEstate.RealEstateProjectStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("RealEstateProjectStatus");
                });
            ...
            modelBuilder.Entity("WebSite.DataLayer.Entities.RealEstate.RealEstateUsageStatus", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
                    ...
                    b.ToTable("RealEstateUsageStatus");
                });
            ...
            modelBuilder.Entity("WebSite.DataLayer.Entities.RealEstate.RealEstate", b =>
                {
                    ...
                    b.HasOne("WebSite.DataLayer.Entities.RealEstate.RealEstateBuildingDirection", "Direction")
                        .WithMany()
                        .HasForeignKey("DirectionRefId");
                    ...
                    b.HasOne("WebSite.DataLayer.Entities.RealEstate.RealEstateUsageStatus", "Usage")
                        .WithMany()
                        .HasForeignKey("UsageRefId");
            ...
            modelBuilder.Entity("WebSite.DataLayer.Entities.RealEstate.RealEstateProject", b =>
                {
                    ...
                    b.HasOne("WebSite.DataLayer.Entities.RealEstate.RealEstateProjectStatus", "Status")
                        .WithMany()
                        .HasForeignKey("StatusRefId");
            ...
            modelBuilder.Entity("WebSite.DataLayer.Entities.RealEstate.RealEstateProjectComment", b =>
                {
                    b.HasOne("WebSite.DataLayer.Entities.RealEstate.RealEstateProject", "Project")
                        .WithMany("CommentList")
