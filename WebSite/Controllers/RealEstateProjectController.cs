...
{    
    public class RealEstateProjectController : BaseController
    {
        ...
        [Route("realestate/project/project/grid")]
        public async Task<IActionResult> Grid(int page = 1, int city=-1, string search = "" )
        {
            var projectList = await _realEstateService.GetProjectList(page, city, search, 24,1);
        ...
        [Route("realestate/project/project/list")]
        ...
        [HttpPost("realestate/project/comment/send")]
        ...
        //search 
        [HttpPost("realestate/project/search"), ValidateAntiForgeryToken]
        ...
        //advance search 
        [Route("realestate/project/search/advance")]
        public async Task<IActionResult> AdvanceSearch()
        {
            ...
            //latest real estate
            var projectList = await _realEstateService.GetRealEstateLatestList(24,1);
        ...
        [HttpPost("realestate/project/search/advance"), ValidateAntiForgeryToken]
        public async Task<IActionResult> AdvanceSearch(RealEstateAdvanceSearchViewModel viewmodel)
        {
            ...
            var projectList = await _realEstateService.GetRealEstateList(1);
        ...
        [Route("realestate/project/comment/{id}")]
