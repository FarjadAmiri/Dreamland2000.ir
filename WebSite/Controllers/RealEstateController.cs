...
{    
    public class RealEstateController : BaseController
    {
        ...
        [Route("realestate/grid")]
        public async Task<IActionResult> Grid(int page = 1, int group = -1,int type=-1,int city=-1, string search = "" )
        {
            var realEstateList = await _realEstateService.GetRealEstateList(page, group,type,city, search, 24,1);
        ...
        [HttpPost("realestate/comment/send")]
        public async Task<IActionResult> SendComment(AddNewRealEstateCommentViewModel viewmodel)
        {
        ...
        //search 
        [HttpPost("realestate/search"), ValidateAntiForgeryToken]
        ...
        //advance search 
        [Route("realestate/search/advance")]
        public async Task<IActionResult> AdvanceSearch()
        {
            //option
            var optionList = await _realEstateService.GetRealEstateOptionList(1);

            //latest real estate
            var realEstateList = await _realEstateService.GetRealEstateLatestList(24,1);
        ...
        [HttpPost("realestate/search/advance"), ValidateAntiForgeryToken]
        public async Task<IActionResult> AdvanceSearch(RealEstateAdvanceSearchViewModel viewmodel)
        {
            ...
            var realEstateList = await _realEstateService.GetRealEstateList(1);
