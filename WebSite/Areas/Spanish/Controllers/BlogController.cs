...
namespace WebSite.Areas.Spanish.Controllers
{
    public class BlogController : BaseController
    {
        ...
        {
            var blogList = await _blogService.GetBlogList(page, group, search,24,3);
        ...
        public async Task<IActionResult> Details(int id) // id = blog id
        {
            ...
            //group list 
            var blogGroupList = await _blogService.GetBlogGroupList(3);
        ...
        //search 
        [HttpPost("es/blog/search"), ValidateAntiForgeryToken]
