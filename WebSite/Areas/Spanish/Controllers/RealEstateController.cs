...
{    
    public class RealEstateController : BaseController
    {
        ...
        [Route("es/realestate/grid")]
        public async Task<IActionResult> Grid(int page = 1, int group = -1,int type=-1,int city=-1, string search = "" )
        {
            var realEstateList = await _realEstateService.GetRealEstateList(page, group,type,city, search, 24,3);
        ...
        [HttpPost("es/realestate/comment/send")]
        ...
        //search 
        [HttpPost("es/realestate/search"), ValidateAntiForgeryToken]
        ...
        //advance search 
        [Route("es/realestate/search/advance")]
        public async Task<IActionResult> AdvanceSearch()
        {
            ...
            //latest real estate
            var realEstateList = await _realEstateService.GetRealEstateLatestList(24,3);
        ...
        [HttpPost("es/realestate/search/advance"), ValidateAntiForgeryToken]
        public async Task<IActionResult> AdvanceSearch(RealEstateAdvanceSearchViewModelEnglish viewmodel)
        {
            ...
            var realEstateList = await _realEstateService.GetRealEstateList(3);
        ...
        [Route("es/realestate/comment/{id}")]
