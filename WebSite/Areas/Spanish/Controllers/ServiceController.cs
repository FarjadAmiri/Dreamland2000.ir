...
namespace WebSite.Areas.Spanish.Controllers
{
    public class ServiceController : BaseController
    {
        ...
        {
            var serviceList = await _serviceItemService.GetServiceList(group,3);
        ...
        [Route("es/service/category")]
        public async Task<IActionResult> Category()
        {
            var serviceGroupList = await _serviceItemService.GetServiceGroupList(3);
        ...
        [HttpPost("es/service/comment/send")]
