...
namespace WebSite.Areas.English.Controllers
{
    public class ServiceController : BaseController
    {
        ...
        {
            var serviceList = await _serviceItemService.GetServiceList(group,2);
        ...
        [Route("en/service/category")]
        public async Task<IActionResult> Category()
        {
            var serviceGroupList = await _serviceItemService.GetServiceGroupList(2);
        ...
        [HttpPost("en/service/comment/send")]
        public async Task<IActionResult> SendComment(AddNewServiceCommentViewModelEnglish viewmodel)
        {
