...
{    
    public class RealEstateProjectController : BaseController
    {
        ...
        [Route("en/realestate/project/project/grid")]
        public async Task<IActionResult> Grid(int page = 1, int city=-1, string search = "" )
        {
            var projectList = await _realEstateService.GetProjectList(page, city, search, 24,2);
        ...
        [Route("en/realestate/project/project/list")]
        ...
        [Route("en/realestate/project/{id}")]
        ...
        [HttpPost("en/realestate/project/comment/send")]
        ...
        //search 
        [HttpPost("en/realestate/project/search"), ValidateAntiForgeryToken]
        ...
        //advance search 
        [Route("en/realestate/project/search/advance")]
        public async Task<IActionResult> AdvanceSearch()
        {
            ...
            //latest real estate
            var projectList = await _realEstateService.GetRealEstateLatestList(24,2);
        ...
        [HttpPost("en/realestate/project/search/advance"), ValidateAntiForgeryToken]
        public async Task<IActionResult> AdvanceSearch(RealEstateAdvanceSearchViewModel viewmodel)
        {
            ...
            var projectList = await _realEstateService.GetRealEstateList(2);
        ...
        [Route("en/realestate/project/comment/{id}")]
