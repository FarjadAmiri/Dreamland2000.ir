...
(function() {
	...
	function findAndReplaceDOMText(regex, node, replacementNode, captureType, schema) {
		...
		function getMatchIndexes(m, captureType) {
		...
		*/
		...
		if (regex.global) {
			while ((m = regex.exec(text))) {
				matches.push(getMatchIndexes(m, captureType));
			}
		} else {
			m = text.match(regex);
			matches.push(getMatchIndexes(m, captureType));
