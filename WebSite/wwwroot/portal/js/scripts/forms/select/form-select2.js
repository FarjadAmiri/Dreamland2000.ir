  ...
  // Basic Select2 select
    ...
    function formatRepo (repo) {
      ...
      markup += "<div class='select2-result-repository__statistics'>" +
        "<div class='select2-result-repository__forks'><i class='fa fa-code-fork mr-0'></i> " + repo.forks_count + " Forks</div>" +
        "<div class='select2-result-repository__stargazers'><i class='fa fa-star-o mr-0'></i> " + repo.stargazers_count + " Stars</div>" +
