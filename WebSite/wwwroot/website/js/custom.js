$(function() {
	...
	// 	$('input[name="checkout"]').attr("placeholder","تا تاریخ");
	// });
	// $(function() {
	...
	// 	$('input[name="checkin"]').attr("placeholder","از تاریخ");
	// });
	...
	$('#lot-1').select2({
		dir: "rtl",
		placeholder: "مکان را انتخاب کنید",
		allowClear: true
	});
